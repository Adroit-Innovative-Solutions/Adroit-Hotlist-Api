...
public interface RTRInterviewRepository extends JpaRepository<RTRInterview,String>, JpaSpecificationExecutor<RTRInterview> {
    ...
    default Page<RTRInterview> salesInterviews(
            String userId,
            String keyword,
            ...
            LocalDate toDate,
            Pageable pageable){
        return findAll(RTRInterviewSpecification.salesInterviews(keyword, filters, userId, fromDate, toDate), pageable);
    }

    Optional<RTRInterview> findByInterviewIdAndIsDeleted(String interviewId,Boolean isDeleted);

    default Page<RTRInterview> teamInterviews(
            ...
            LocalDate toDate,
            Pageable pageable){
        return findAll(RTRInterviewSpecification.teamInterviews(consultantIds, keyword, filters, fromDate, toDate), pageable);
    }
